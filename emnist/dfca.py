...
class TrainEMNISTCluster(object):
    ...
    def setup_datasets(self):
        ...
        EMNIST_TRAINSET_DATA_SIZE = 100000
        EMNIST_TESTSET_DATA_SIZE = 20000
    ...
    def _load_EMNIST(self, train=True):
        ...
        if train:
            emnist_dataset = datasets.EMNIST(root='./data', split='letters', train=True, download=True, transform=transforms)
        else:
            emnist_dataset = datasets.EMNIST(root='./data', split='letters', train=False, download=True, transform=transforms)
